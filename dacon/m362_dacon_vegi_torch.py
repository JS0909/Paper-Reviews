...
all_input_list = sorted(glob.glob('D:\study_home\_data\dacon_vegi/train_input/*.csv'))
all_target_list = sorted(glob.glob('D:\study_home\_data\dacon_vegi/train_target/*.csv'))
...
test_input_list = sorted(glob.glob('D:\study_home\_data\dacon_vegi/test_input/*.csv'))
test_target_list = sorted(glob.glob('D:\study_home\_data\dacon_vegi/test_target/*.csv'))
