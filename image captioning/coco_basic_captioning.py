...
with open('F:\study_home\_data/team_project\coco\json_files/captions_train2014.json', 'r') as f:
...
for annot in annotations['annotations']:
  ...
  full_coco_image_path = 'F:\study_home\_data/team_project\coco/train2014/' + 'COCO_train2014_' + '%012d.jpg' % (image_id)
