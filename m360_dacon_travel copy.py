...
import numpy as np 
#1. 데이터
path =  'D:\study_home\_data\dacon_travel/' # ".은 현재 폴더"
...
#     'n_estimators':[100,200,300,400,500,1000],
    ...
    # }
# xgb = XGBClassifier(random_state=704)
# model = GridSearchCV(xgb,parameters_xgb,cv=kfold,n_jobs=-1)


# parameters_rnf = {
#     'n_estimators':[300],
#     'max_depth':[None],
#     'min_samples_leaf':[2,3,5,7,10,11,13],
#     'min_samples_split':[2,3,5,7,10],
# }
# rnf = RandomForestClassifier(random_state=666)
# model = GridSearchCV(rnf,parameters_rnf,cv=kfold,n_jobs=-1)
...
# 최적의 매개변수 :  {'depth': 9, 'l2_leaf_reg': 5.535171839105427, 'learning_rate': 0.20909079092170735, 'model_size_reg': 0.30614059763442997, 'od_pval': 0.236844398775451}
# 최상의 점수 :  0.9108539156027523
# acc : 0.9476744186046512